...
<!-- eslint-disable -->
  <svg version="1.1" id="snowShowersIcon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
    ...
    <g id="rain">
      <path id="snowFlake1" fill="#FFFFFF" d="M25.4,36.5l0.2-0.2L25.2,36l0.4-0.2l-0.1-0.2l-0.4,0.2l0-0.5l-0.3,0l0,0.6L24.6,36l0-0.7l-0.3,0l0,0.8
      ...
      <path id="snowFlake2" fill="#FFFFFF" d="M50.8,36.1l0.2-0.2l-0.4-0.3l0.5-0.2L51,35.1l-0.5,0.2l0-0.5l-0.3,0l0,0.6l-0.2,0.1l0-0.7l-0.3,0l0,0.9
      ...
      <path id="snowFlake3" fill="#FFFFFF" d="M35.2,37.2l0.2-0.2L35,36.8l0.4-0.2l-0.1-0.2l-0.4,0.2l0-0.4l-0.3,0l0,0.5l-0.2,0.1l0-0.6l-0.3,0l0,0.7
      ...
      <path id="snowFlake4" fill="#FFFFFF" d="M41.3,38.9l0.1-0.1l-0.2-0.1l0.2-0.1l0-0.1l-0.2,0.1l0-0.3l-0.2,0l0,0.3l-0.1,0.1l0-0.4l-0.2,0l0,0.4
      ...
      <path id="snowFlake5" fill="#FFFFFF" d="M55.8,38.9l0.1-0.1l-0.2-0.1l0.2-0.1l0-0.1l-0.2,0.1l0-0.3l-0.2,0l0,0.3l-0.1,0.1l0-0.4l-0.2,0l0,0.4
...
<style lang="scss" scoped>
  ...
  #snowFlake3 {
    animation: snowFlakeAnimation70deg 3s infinite linear 1s;
    transform-origin: center center 0px;
    transition: all 0.2s ease 0s;
  }
  #snowFlake4 {
  ...
  #snowFlake5 {
    animation: snowFlakeAnimation25deg 3s infinite linear 1.5s;
    transform-origin: center center 0px;
    transition: all 0.2s ease 0s;
  }
  ...
  @keyframes snowFlakeAnimation70deg {
    0% {
      opacity: 1;
      transform: matrix3d(
        1, 0, 0, 0,
  ...
  @keyframes snowFlakeAnimation25deg {
    0% {
      opacity: 1;
      transform: matrix3d(
        1, 0, 0, 0,
