...
<g id="cloud2">
	<path fill="#A7A9AC" d="M67.8,27.9c0,1.9-2.1,3.4-4.8,3.4H34.5c-2.6,0-4.8-1.5-4.8-3.4l0,0c0-1.9,2.1-3.4,4.8-3.4H63
		C65.7,24.5,67.8,26.1,67.8,27.9L67.8,27.9z"/>
	<circle fill="#E6E7E8" cx="47.2" cy="19.9" r="6.2"/>
	<circle fill="#A7A9AC" cx="54.1" cy="23.9" r="5.7"/>
	<path fill="#E6E7E8" d="M54.1,18.2c-1.3,0-2.6,0.5-3.6,1.3c-0.6,0.9-1,2.1-1,3.3c0,3.2,2.6,5.8,5.8,5.8c1.2,0,2.3-0.4,3.3-1
		c0.8-1,1.3-2.2,1.3-3.6C59.8,20.7,57.2,18.2,54.1,18.2z"/>
	<circle fill="#A7A9AC" cx="64.1" cy="27.6" r="3.7"/>
	<circle fill="#A7A9AC" cx="33.8" cy="26.6" r="4.7"/>
...
<g id="cloud1">
	...
	<path fill="#E6E7E8" d="M12.2,31.3c0-1.3-0.6-2.5-1.4-3.3c-0.6-0.3-1.3-0.5-2.1-0.5c-2.6,0-4.7,2.1-4.7,4.7c0,0.7,0.2,1.5,0.5,2.1
		c0.8,0.9,2,1.4,3.3,1.4C10.2,35.8,12.2,33.8,12.2,31.3z"/>
	<circle fill="#A7A9AC" cx="14.3" cy="30.2" r="5.6"/>
	<path fill="#E6E7E8" d="M14.3,24.6c-3.1,0-5.6,2.5-5.6,5.6c0,1.1,0.3,2.1,0.8,2.9c1,0.9,2.3,1.4,3.7,1.4c3,0,5.5-2.4,5.5-5.5
		c0-1.4-0.5-2.7-1.4-3.7C16.4,24.9,15.4,24.6,14.3,24.6z"/>
	<circle fill="#A7A9AC" cx="35.8" cy="29.6" r="4"/>
	<path fill="#E6E7E8" d="M35.9,32.7c2,0,3.7-1.5,3.9-3.5c-0.2-2-1.9-3.6-3.9-3.6c-1.8,0-3.3,1.2-3.8,2.9c0,0.1,0,0.2,0,0.3
		C32,30.9,33.7,32.7,35.9,32.7z"/>
	<path fill="#E6E7E8" d="M39,29.6c-1.9,0-3.5,1.4-3.7,3.3c0.1,1.9,1.7,3.4,3.7,3.4c1.9,0,3.5-1.5,3.7-3.3C42.5,31,41,29.6,39,29.6z"
		/>
</g>
<g id="cloud0">
	<circle fill="#D1D3D4" cx="22.1" cy="35.2" r="9.8"/>
	<circle fill="#F1F2F2" cx="42.4" cy="32.6" r="7.8"/>
